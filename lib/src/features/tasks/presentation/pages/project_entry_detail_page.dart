...
class ProjectEntryDetailPage extends StatefulWidget {
  const ProjectEntryDetailPage({
    super.key,
  ...
  @override
  State<ProjectEntryDetailPage> createState() => _ProjectEntryDetailPageState();
}

class _ProjectEntryDetailPageState extends State<ProjectEntryDetailPage> {
